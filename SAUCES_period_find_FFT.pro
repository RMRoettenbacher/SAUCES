pro SAUCES_period_find_FFT, directoryname, target, initperiod, rotperiod, typeofstar
;
...
; 4 January 2018 Updated to have output names consistent with other processes
